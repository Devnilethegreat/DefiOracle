...
class DefiOracle {
  constructor() {
    ...
    this.core = new DefiOracleCore(this.threshold);
  }
  ...
  async run() {
    try {
      logger.info('Starting DefiOracle processing pipeline');
...
module.exports = { DefiOracle, DefiOracleCore };
